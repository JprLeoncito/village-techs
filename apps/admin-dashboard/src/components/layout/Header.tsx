...
import { Bars3Icon, ArrowRightOnRectangleIcon, UserIcon, KeyIcon, ChevronDownIcon } from '@heroicons/react/24/outline'
...
export function Header() {
  ...
  const roleDisplay = user?.role === 'admin_head' ? 'Admin Head' : 'Admin Officer'
